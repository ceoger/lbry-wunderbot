...
function embedFromClaim(claim) {
  ...
  switch (claim.claim_type) {
    case typeClaim:
      ...
      e.setAuthor(`New claim from ${channelName}`, 'http://barkpost-assets.s3.amazonaws.com/wp-content/uploads/2013/11/3dDoge.gif', `http://open.lbry.com/${claimPermalink}`)
        .setTitle(`lbry://${claimPermalink}`)
        .setURL(`http://open.lbry.com/${claimPermalink}`)
        .setColor(1399626)
